# What five agents found — the first run

> **This run leaked.** The harness injected the project's `CLAUDE.md` into
> every agent before it received its brief; *A note on method* at the end
> says so. It was repeated in a clean room on 2026-09-01, and that run is
> `FINDINGS.md`. The five diagrams this file describes are at commit
> `c95b816`; the folders now hold the clean-room set.
