...
Write the diagram to `examples/gallery/14-subsea/bottle.json`.
...
Append to `examples/gallery/14-subsea/rounds.md` **as you go**, one section per
...
Write `examples/gallery/14-subsea/findings.md` at the end, covering:
