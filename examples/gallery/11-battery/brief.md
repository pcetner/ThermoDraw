...
python -m thermodraw check    examples/gallery/11-battery/pack.json
python -m thermodraw describe examples/gallery/11-battery/pack.json
python -m thermodraw render   examples/gallery/11-battery/pack.json -o examples/gallery/11-battery/pack.svg
```

Write the diagram to `examples/gallery/11-battery/pack.json`.
...
Append to `examples/gallery/11-battery/rounds.md` **as you go**, one section per
...
Write `examples/gallery/11-battery/findings.md` at the end, covering:
